...
var compass = function(){
	...
	{
		leftArrow.shape.canvas.className = newClassName;
		rightArrow.shape.canvas.className = newClassName;
		topArrow.shape.canvas.className = newClassName;
		bottomArrow.shape.canvas.className = newClassName;
		compassCenter.shape.canvas.className = newClassName;
	}
}();